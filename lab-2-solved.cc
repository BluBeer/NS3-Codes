...
//
  ...
  anim.SetConstantPosition(c.Get(1),0.0,40.0);
  anim.SetConstantPosition(c.Get(4),50.0,20.0);
  anim.SetConstantPosition(c.Get(5),100.0,20.0);
  anim.SetConstantPosition(c.Get(2),150.0,0.0);
  anim.SetConstantPosition(c.Get(3),150.0,40.0);
  Simulator::Run ();
  if (enableFlowMonitor)
    {
